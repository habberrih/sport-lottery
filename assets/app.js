...
btn.addEventListener('click', () => {
  if (slots[0].classList.contains('visible')) {
    ...
    numberSpin('scroll1').stop(5000, Math.floor(winner / 1000));
    numberSpin('scroll2').stop(6000, Math.floor((winner % 1000) / 100));
    numberSpin('scroll3').stop(7000, Math.floor(winner % 100) / 10);
    numberSpin('scroll4').stop(8000, winner % 10);
